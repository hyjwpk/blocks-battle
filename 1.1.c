...
#define CHARACTER1 {SetConsoleOutputCP(437);printf("%c",219);}
#define CHARACTER2 {printf("%c",221);}
#define CHARACTER3 {printf("%c",220);}
#define CHARACTER4 {printf("%c",222);}
#define CHARACTER5 {printf("%c",223);}
#define CHARACTER6 {printf("%c",254);}

#define STATE {position(70,1);printf("State%d",state);}
#define GAME {position(70,2);printf("Game%d",game);}
#define SCORE {position(70,3);printf("score = %d",score);}

//#define CHARACTER {cout  << "\033[32m修改\033[0m"<< endl ;}
//1--砖 2--左边框 3--底板 4--右边框 5--上边框 6--球 
int score=0,game=1,state=1;
int board=20;
...
//	SetConsoleOutputCP(437);
	...
	system("mode con cols=120 lines=50");//窗口宽度高度
	system("cls");
	system("color 54");
